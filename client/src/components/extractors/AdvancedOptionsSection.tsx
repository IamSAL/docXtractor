...
export function AdvancedOptionsSection({ onResetPrompt, onUploadFile }: AdvancedOptionsSectionProps) {
    const { control, watch, setValue, getValues, formState: { errors } } = useFormContext<ExtractorFormData>()
