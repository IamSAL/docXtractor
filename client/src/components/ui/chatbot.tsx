          ...
          >
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <div className="flex flex-col ml-4">
                    <h3 className="font-semibold text-base text-green-600 leading-none">
                      {title}
                    </h3>
            ...
            <ScrollArea className="flex-1 px-4 relative z-0 overflow-hidden">
              <div className="flex flex-col justify-start space-y-4 mt-4 -pb-4 -mb-8">
                <div className="flex flex-col items-center justify-center mb-6 text-green-400">
                  <Avatar
                  ...
                  <p className="font-normal my-2">Krista answers instantly</p>
