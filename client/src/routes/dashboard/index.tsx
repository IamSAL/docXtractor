                ...
                <div className="col-span-full">
                  <Card className="p-8 flex flex-col gap-6 bg-yellow-50/50 border-2 border-black border-dashed">
                    <div className="text-center">
                      ...
                      <h4 className="font-black text-xl tracking-tight mb-1">
                        Welcome! Let's extract your first document.
                      </h4>
                      <p className="text-gray-500 text-sm max-w-md mx-auto">
                        DocXtractor turns documents into structured data in 3
                        steps.
                      </p>
                    </div>
                      ...
                      {[
                        {
                          step: "1",
                          icon: "fork_right",
                          label: "Create an Extractor",
                          desc: "Define what data to pull out of your documents",
                        },
                        {
                          step: "2",
                          icon: "upload_file",
                          label: "Upload a Document",
                          desc: "PDF, image, URL — any format works",
                        },
                        {
                          step: "3",
                          icon: "table_chart",
                          label: "View Structured Results",
                          desc: "Get clean JSON or spreadsheet output instantly",
                        },
                      ].map(({ step, icon, label, desc }) => (
                        <div
                          key={step}
                          className="bg-white border-2 border-black p-4 flex flex-col gap-2 shadow-[2px_2px_0px_0px_#000]"
                        >
                          <div className="flex items-center gap-2">
                            <span className="text-xs font-black bg-black text-white w-5 h-5 flex items-center justify-center rounded-full shrink-0">
                              {step}
                            </span>
