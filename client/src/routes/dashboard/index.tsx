...
function RouteComponent() {
    return (
        <>
            {/* Left Sidebar */}
            <aside className="w-64 bg-white border-r-[3px] border-black flex flex-col h-screen fixed left-0 top-0 z-10">
                {/* Logo Area */}
                ...
                <nav className="flex-1 p-4 flex flex-col gap-3 overflow-y-auto">
                    <a
                        className="neobrutal-sidebar-item active flex items-center gap-3 px-4 py-3 rounded-lg text-black"
                        href="#"
                    >
                    ...
                    <a
                        className="neobrutal-sidebar-item flex items-center gap-3 px-4 py-3 rounded-lg text-black"
                        href="#"
                    >
                ...
                {/* User Profile */}
                <div className="p-4 border-t-[3px] border-black bg-yellow-50">
            ...
            {/* Main Content */}
            <main className="ml-64 flex-1 flex flex-col h-screen overflow-hidden p-8 lg:p-12 relative">
                {/* Header Section */}
