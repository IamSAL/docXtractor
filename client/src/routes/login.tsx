            ...
            <Card shadowsize="lg" className="relative w-full max-w-md p-8 md:p-10 border-4 animate-fade-in">
                ...
                <div className="mt-8 pt-6 border-t-2 border-black flex justify-center">
                    <p className="text-black font-medium text-sm">
                        ...
                        <Link to="/signup" replace className="font-bold underline decoration-2 decoration-primary underline-offset-4 hover:bg-primary hover:text-black transition-colors px-1 ml-1 no-underline">Sign Up</Link>
                    </p>
                </div>
