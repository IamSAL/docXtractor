...
function ExtractorsComponent() {
  ...
  const filteredExtractors = extractorsList.filter(
    (extractor) =>
      ...
      <div className="flex flex-col h-full p-4 lg:p-12">
        ...
        <div className="bg-gray-100 border-2 border-black p-4 mb-8">
          <div className="w-full flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex items-center gap-3 overflow-x-auto">
              <Button
                variant="outline"
                className="flex items-center gap-2 px-3 py-3 bg-white border-2 border-black shadow-[2px_2px_0px_0px_#000000] rounded-sm cursor-pointer hover:-translate-y-[1px] transition-transform shrink-0 h-auto"
                type="button"
              >
              ...
              <Button
                variant="outline"
                className="flex items-center justify-center w-12 h-12 bg-white border-2 border-black shadow-[2px_2px_0px_0px_#000000] rounded-sm cursor-pointer hover:bg-gray-50 shrink-0 p-0"
                title="Sort Order"
                type="button"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 pb-12">
                ...
                <div className="mt-auto pt-4 border-t-2 border-dashed border-gray-300 flex items-center justify-between">
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span className="text-xs font-bold font-mono uppercase">
                      {
                        Object.keys((extractor.schema as any)?.properties || {})
                          .length
                      }{" "}
                      FIELDS
                    </span>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-500 group-hover:text-black mb-1 uppercase text-center">
