...
export class InitialSchema1777313147579 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."workflows_status_enum" AS ENUM('draft', 'active', 'paused')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."workflow_executions_status_enum" AS ENUM('pending', 'running', 'success', 'failed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."node_executions_status_enum" AS ENUM('pending', 'running', 'success', 'failed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."runs_status_enum" AS ENUM('pending', 'queued', 'parsing', 'extracting', 'done', 'failed', 'review')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."files_status_enum" AS ENUM('pending', 'completed')`,
    );
    await queryRunner.query(
