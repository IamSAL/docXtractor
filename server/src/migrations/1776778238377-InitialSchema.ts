...
export class InitialSchema1776778238377 implements MigrationInterface {
  name = 'InitialSchema1776778238377';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."admin_admintype_enum" AS ENUM('super', 'support')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_89563b3922141f854f717db7be" ON "user" ("role", "isEmailVerified") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."workflows_status_enum" AS ENUM('draft', 'active', 'paused', 'archived')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."workflow_executions_status_enum" AS ENUM('pending', 'running', 'success', 'failed', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_a541edf52e3d80b42c51672995" ON "files" ("userId", "createdAt") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."invite_role_enum" AS ENUM('user', 'admin')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."invite_status_enum" AS ENUM('pending', 'accepted', 'expired', 'revoked')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "workflows" ADD CONSTRAINT "FK_e6b7312458454123287286afa6e" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflow_executions" ADD CONSTRAINT "FK_2cb399c231cb3f82c63506794bc" FOREIGN KEY ("workflowId") REFERENCES "workflows"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "node_executions" ADD CONSTRAINT "FK_1ae2ec85514f6d5b9b97a0f161c" FOREIGN KEY ("executionId") REFERENCES "workflow_executions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "runs" ADD CONSTRAINT "FK_373b603026a04de33489fd2692f" FOREIGN KEY ("extractorId") REFERENCES "extractor"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "runs" ADD CONSTRAINT "FK_2d1962c3d0e1fe76f2921431991" FOREIGN KEY ("workflowExecutionId") REFERENCES "workflow_executions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "files" ADD CONSTRAINT "FK_7e7425b17f9e707331e9a6c7335" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "invite" ADD CONSTRAINT "FK_180928f0ebd300b55317c75ce72" FOREIGN KEY ("acceptedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "invite" DROP CONSTRAINT "FK_180928f0ebd300b55317c75ce72"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "runs" DROP CONSTRAINT "FK_2d1962c3d0e1fe76f2921431991"`,
    );
    await queryRunner.query(
      `ALTER TABLE "runs" DROP CONSTRAINT "FK_336a74d21129fee621d57b01799"`,
    );
    await queryRunner.query(
      `ALTER TABLE "runs" DROP CONSTRAINT "FK_373b603026a04de33489fd2692f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "extractor" DROP CONSTRAINT "FK_8343e394266c0fc3ae00847041f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "node_executions" DROP CONSTRAINT "FK_1ae2ec85514f6d5b9b97a0f161c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflow_executions" DROP CONSTRAINT "FK_2cb399c231cb3f82c63506794bc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflows" DROP CONSTRAINT "FK_e6b7312458454123287286afa6e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_373b603026a04de33489fd2692"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6906dec2148d994d17d1a4a3b5"`,
    );
    await queryRunner.query(`DROP TABLE "runs"`);
    await queryRunner.query(`DROP TYPE "public"."runs_status_enum"`);
    await queryRunner.query(
      `DROP TYPE "public"."runs_extractionprovider_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."extractor_conflictresolution_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."workflow_executions_status_enum"`,
    );
    await queryRunner.query(`DROP TABLE "workflows"`);
    await queryRunner.query(`DROP TYPE "public"."workflows_status_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_89563b3922141f854f717db7be"`,
    );
